      ...
      <div class="card-body">
        <form enctype="multipart/form-data">
            ...
            <div class="form-group">
              <div class="mb-2 label">Foto BPJS Kesehatan</div>
              ...
              <small class="form-text text-muted">*Foto bpjs hanya dapat dimasukkan sekali</small>
            </div>
            <!-- <div class="form-group">
...
export default {
  ...
  methods:{
    ...
    submitFile(){
      ...
      axios.post('https://sixacti-api.herokuapp.com/api/uploadBpjsKesehatan/' + this.idLamaran,
