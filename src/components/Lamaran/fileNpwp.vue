      ...
      <div class="card-body">
        <form enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <small class="form-text text-muted">*Foto npwp hanya dapat dimasukkan sekali</small>
            </div>
            <!-- <div class="form-group">
...
export default {
  ...
  methods:{
    ...
    submitFile(){
      ...
      axios.post('https://sixacti-api.herokuapp.com/api/uploadNpwp/' + this.idLamaran,
