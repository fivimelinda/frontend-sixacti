      ...
      <div class="card-body">
        <form enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <small class="form-text text-muted">*Resume hanya dapat dimasukkan sekali</small>
            </div>
            <!-- <div class="form-group">
            ...
            <button class=" mt-5 mb-5 btn btn-dark" v-on:click="afterClicked()">Tutup</button>
        </form>
...
export default {
  ...
  methods:{
    ...
    submitFile(){
      ...
      axios.post('https://sixacti-api.herokuapp.com/api/uploadFile/' + this.idLamaran,
